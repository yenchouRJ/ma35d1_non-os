 ...
 * @file     main.c
 *
 * @brief    FreeRTOS-SMP UDP echo client using LwIP.
 *           Client sends UDP datagrams to 192.168.1.2:80 from IP 192.168.1.3.
 *           Sends "Hi there..." and prints the echoed response.
 *
...
int main(void)
{
    ...
    sysprintf("FreeRTOS is starting ...\n");
        ...
        xTaskCreate( vUdpTask, "UdpTask", UDP_THREAD_STACKSIZE, NULL, UDP_TASK_PRIORITY, &xUdpTaskHandle );
        vTaskCoreAffinitySet( xUdpTaskHandle, 0x01 );
#else
