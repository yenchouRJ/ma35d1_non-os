...
/* Per-core interrupt nesting depth - exported by port.c / portASM.S. */
 ...
 *
 * Validation:
 *   - Both tasks complete all rounds.
 *   - The receiver actually ran on Core 1.
 *===========================================================================*/
#if ( DEMO5_PINGPONG == 1 )
